    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        context?.let { it ->
            ...
            btn_grupo.setOnClickListener {
                val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://chat.whatsapp.com/L6CXlGhB5JXCmdBaPzlpPA"))
                startActivity(i)
            }

            btn_descargas.setOnClickListener {
                val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.apn.gob.pe/site/prensa-y-publicaciones/eventos.aspx"))
                startActivity(i)
            }
        }
    }
