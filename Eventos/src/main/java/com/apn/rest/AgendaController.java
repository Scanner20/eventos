...
public class AgendaController {
	...
	@GetMapping(value = "/id/{idAgenda}")

	public ResponseEntity<?> loginUsuario(@PathVariable("idAgenda") String id) {
		...
		try {
			...
			List<Agenda> oUsuarioCatalogo= agendaService.loginUsuario(id);
